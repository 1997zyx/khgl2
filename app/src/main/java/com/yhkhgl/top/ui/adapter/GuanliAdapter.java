...
public class GuanliAdapter extends RecyclerView.Adapter<ViewHolder> {
    private SoftReference<GuanLiActivity> softReference;
    private List<GuanliListBean> listBeans;
    int year, month, day;
    String str;

    public GuanliAdapter(GuanLiActivity mcontext, List<GuanliListBean> beans) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (listBeans.get(position).getChannel() == null ||listBeans.get(position).getChannel().equals("")){
            qudao_tv.setText("暂无");
        }else {
        ...
        if (listBeans.get(position).getKey_categories() == null||listBeans.get(position).getKey_categories().equals("") ){
            dengji_tv.setText("暂无");
        }else {
        ...
        if (listBeans.get(position).getCredit_inquiry() == null ||listBeans.get(position).getCredit_inquiry().equals("")){
            zhengxin_tv.setText("暂无");
        }else {
        ...
        switch (follow_status) {
            ...
            default:
                ...
                break;
//            case "未接通":
//                follow_tv.setTextColor(getColor(R.color.f4dd0e1));
//                break;
//            case "跟进":
//                follow_tv.setTextColor(getColor(R.color.f00a0e9));
//                break;
//            case "办理中":
//                follow_tv.setTextColor(getColor(R.color.f1d2089));
//                break;
//            case "审核拒绝":
//                follow_tv.setTextColor(getColor(R.color.fe60012));
//                break;
//            case "不需要":
//                follow_tv.setTextColor(getColor(R.color.f4dd0e1));
//                break;
//            case "重点":
//                follow_tv.setTextColor(getColor(R.color.f215dff));
//                break;
//            case "成交":
//                follow_tv.setTextColor(getColor(R.color.f651fff));
//                break;
//            case "不符合":
//                follow_tv.setTextColor(getColor(R.color.fe60012));
//                break;
