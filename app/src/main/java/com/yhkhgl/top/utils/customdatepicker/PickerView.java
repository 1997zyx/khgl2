package com.yhkhgl.top.utils.customdatepicker;
...
public class PickerView extends View {
    ...
    public void startAnim() {
        ...
        if (mScrollAnim == null) {
            PropertyValuesHolder alpha = null;
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                alpha = PropertyValuesHolder.ofFloat("alpha", 1f, 0f, 1f);
            }
            PropertyValuesHolder scaleX = null;
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                scaleX = PropertyValuesHolder.ofFloat("scaleX", 1f, 1.3f, 1f);
            }
            PropertyValuesHolder scaleY = null;
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                scaleY = PropertyValuesHolder.ofFloat("scaleY", 1f, 1.3f, 1f);
            }
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
