package com.yhkhgl.top.utils.sunUi.circularImage;
    ...
    public ZoomImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        gestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public void onLongPress(MotionEvent e) {//长按事件
                onMyLongClickListener.onMyLongClickCoordinate();
//                runnable.run();
            }
...
//
//                Log.e("ACTION_DOWN", "run: "+"ACTION_DOWN" );
//                isMove = false;
//                lastX = x;
//                lastY = y;
...
//                Log.e("ACTION_MOVE", "run: "+"ACTION_MOVE" );
//                Log.e("lastX", "run: "+lastX );
//                Log.e("x", "run: "+x );
//                Log.e("u", "run: "+y );
//                if (isMove){
//                    break;
...
//        }
    ...
    public void scale(ScaleGestureDetector detector) {
        ...
        //获取手势操作的值,scaleFactor>1说明放大，<1则说明缩小(系统定义的缩放值)
